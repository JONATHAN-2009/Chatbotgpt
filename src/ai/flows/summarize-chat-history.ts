...
/**
 * @fileOverview Summarizes long chat histories to quickly understand the topics discussed.
 *
...
const SummarizeChatHistoryInputSchema = z.object({
  chatHistory: z.string().describe('The complete chat history to be summarized.'),
});
